...
public class LoginTest {
    ...
    public void testPersonalAccountLogin() {
        openMainPageAndClickAccountButton();
        checkRedirectedToLoginPage();
        login();
        checkItPossibleToOpenAccountPage();
    }
    ...
    public void testRegistrationLogin() {
        clickLoginButtonInRegistrationPage();
        checkRedirectedToLoginPage();
        login();
        checkItPossibleToOpenAccountPage();
    }
    ...
    public void testRestorePasswordLogin() {
        openForgotPasswordAndClickAccountButton();
        checkRedirectedToLoginPage();
        login();
        checkItPossibleToOpenAccountPage();
    }
    ...
    private void openForgotPasswordAndClickAccountButton() {
    ...
    private void openMainPageAndClickAccountButton() {
    ...
    private void clickLoginButtonInRegistrationPage() {
